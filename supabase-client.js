...
/* ---------------- File storage (documents & vision board images) ----------------
   Files are stored at path: {userId}/{timestamp}-{filename} inside the
   'attachments' bucket, matching the RLS policy set up in the Supabase dashboard. */
